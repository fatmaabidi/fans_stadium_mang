sap.ui.define([
...
], function (Controller, Popover, Button, library, jQuery, JSONModel, Fragment, MessageBox, syncStyleClass, MessageToast, DateFormat) {
	"use strict";
	var iTimeoutId;
	...
	return Controller.extend("stadium.stadium.controller.Forum", {
		onInit: function () {
			// set mock model
			var sPath = sap.ui.require.toUrl("stadium/stadium/model/feed.json");
